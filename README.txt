...
The same functions are heavily used in update functions for developing 
sites. This needs documenting!
...
* Also on Github - http://github.com/bmann/install_profile_api
